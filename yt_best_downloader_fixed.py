...
"""
Fixed YouTube Downloader - Clean, effective version
Based on the lesson: LESS complexity = MORE quality
"""
...
def build_opts(args) -> Dict[str, Any]:
    """Build yt-dlp options - KEEP IT SIMPLE for best results"""
    ...
    # Base options - minimal interference
    opts = {
        "outtmpl": outtmpl,
    ...
    # Quality selection - PROVEN to work better than complex alternatives
...
def main():
    parser = argparse.ArgumentParser(description="Fixed YouTube Downloader (Proven to work!)")
    ...
    parser.add_argument("--quality", choices=["best", "hd", "sd", "any", "audio"], 
                       default="best", help="Quality preset (best=1080p+)")
    parser.add_argument("--player", choices=["default", "web", "tv", "ios", "android"],
                       default="default", help="Player variant (try 'tv' if issues)") 
